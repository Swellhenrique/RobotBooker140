...
Task Setup    Create Token    ${url}
Test Template    Create Booking DDT

*** Test Cases ***

TC01    ${firstname}    ${lastname}    ${totalprice}    ${depositpaid}    ${checkin}    ${checkout}    ${additionalneeds}

TC02    ${firstname}    ${lastname}    ${totalprice}    ${depositpaid}    ${checkin}    ${checkout}    ${additionalneeds}
